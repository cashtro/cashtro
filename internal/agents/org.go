	...
	org := Organization{
		...
		Departments: []Department{
			...
			},
			{
				...
				Mandate: "Epicenter Einstein et Voltron dirigent. Le commit reste sur les sites WordPress (PHP, ACF Pro, XAMPP) et sur Proximity, Next Proximity, Proximity App, et Api-Proximity. Lovable n'y touche pas.",
				Members: []Member{
			...
			},
			{
				...
				Mandate: "La technologie qui fait tourner les workers, pas un résultat ajouté après. Chaque division a une fonction et un produit. Voltron tient le kernel. Epicenter Einstein lance le cycle.",
				Members: []Member{
		...
		Divisions: []Division{
			...
			{ID: "nft-giant", Name: "NFT + Giant", Chief: "manager", Department: "controle", Function: "manager.run", Product: "Evolu-Jeunes/Giant brain", Revenue: "Art avec utilité, token Giant, lecture de marché.", Guard: "Epicenter Einstein décide en dernier. Pas de mint, pas d'ordre, pas de pont."},
			...
			{ID: "marketing", Name: "Marketing", Chief: "planner", Department: "marche", Function: "manager.crm", Product: "Evolu-Jeunes/CRM-Agents", Revenue: "L'agence: marketing, Panda, Proximity cloud. Elle relie chaque chaîne.", Guard: "Les leads passent dans la copie agents. La copie Fix Tout n'y entre pas. Lovable n'entre pas dans WordPress. Epicenter Einstein décide avant un envoi."},
			{ID: "fix2", Name: "Fix Tout", Chief: "operator", Department: "operations", Function: "operator.work", Product: "Evolu-Jeunes/Fix2", Revenue: "Homme à tout faire, résidentiel. Le site garde tous les clients.", Guard: "Pas le carnet des agents. Pas WordPress. Pas d'envoi, pas de paiement, pas de permis déposé. Epicenter Einstein décide."},
