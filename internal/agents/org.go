...
func Chart() Organization {
	org := Organization{
		...
		Divisions: []Division{
			...
			{ID: "marketing", Name: "Marketing", Chief: "planner", Department: "marche", Function: "manager.crm", Product: "carnet des agents", Revenue: "L'agence: marketing, Panda, Proximity cloud. Elle relie chaque chaîne.", Guard: "Les leads passent ici. Le CRM Lovable de Fix2 n'y entre pas. Lovable n'entre pas dans WordPress. Epicenter décide avant un envoi."},
