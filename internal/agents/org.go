...
func Chart() Organization {
	org := Organization{
		...
		Divisions: []Division{
			...
			{ID: "fix2", Name: "Fixtool", Chief: "operator", Department: "operations", Function: "operator.work", Product: "Evolu-Jeunes/Fix2", Revenue: "Homme à tout faire, résidentiel. Le site garde tous les clients.", Guard: "Pas le carnet des agents. Pas WordPress. Pas d'envoi, pas de paiement, pas de permis déposé. Epicenter décide."},
