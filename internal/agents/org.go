...
func Chart() Organization {
	org := Organization{
		...
		Divisions: []Division{
			...
			{ID: "marketing", Name: "Marketing", Chief: "planner", Department: "marche", Function: "manager.crm", Product: "Evolu-Jeunes/CRM", Revenue: "Campagnes. Les agents grandissent dans ce carnet. La voix est Vapi.", Guard: "Brouillon seulement. Fix2 n'y écrit pas. Lovable n'entre pas dans WordPress. Aucun appel ne part. Epicenter décide avant un envoi."},
			{ID: "fix2", Name: "Fix2", Chief: "operator", Department: "operations", Function: "operator.work", Product: "Evolu-Jeunes/Fix2", Revenue: "Construction. Son carnet est à part. La voix est Vapi.", Guard: "Pas le carnet des agents. Pas WordPress. Pas Lovable. Pas d'appel sans clé. Pas d'envoi, pas de paiement, pas de permis déposé. Epicenter décide."},
