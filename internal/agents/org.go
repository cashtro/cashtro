...
func Chart() Organization {
	org := Organization{
		...
		Divisions: []Division{
			...
			{ID: "marketing", Name: "Marketing", Chief: "planner", Department: "marche", Function: "manager.crm", Product: "Evolu-Jeunes/CRM", Revenue: "Un seul carnet Lovable pour les contacts, les leads et les notes.", Guard: "Brouillon seulement. Lovable n'entre pas dans WordPress. Epicenter décide avant un envoi."},
