...
func lineKnown(id string) map[string]string {
	...
	case "control":
		return map[string]string{
			"situation":   "Le tableau est chargé. Epicenter Einstein tranche.",
	...
	case "wordpress":
		return map[string]string{
			"situation":   "Epicenter Einstein et Voltron dirigent. Le commit va sur un site WordPress, Proximity, Next Proximity, Proximity App, ou l'API.",
			"manque":      "L'accord avant de quitter le local.",
			"intouchable": "Lovable, Epicenter Einstein, Voltron, et toute marque qui n'est pas dans la demande.",
		}
	case "proximity":
		return map[string]string{
	...
	case "nft-giant":
		return map[string]string{
			"situation":   "Giant a son cerveau crypto et il est en formation. Voltron ouvre, Giant travaille, Epicenter Einstein décide à la fin. Le mint n'est pas une option.",
			"manque":      "La fin de la formation, puis la décision d'Epicenter Einstein, avant un mint, un ordre, un déploiement, ou un pont.",
			"intouchable": "Remplacer le cerveau de Giant par celui d'Epicenter Einstein, un ordre live, ou un mint de CQ.",
		}
	case "ecole":
		return map[string]string{
	...
	case "marketing":
		return map[string]string{
			...
			"manque":      "Le consentement avant un envoi, et la décision d'Epicenter Einstein.",
	...
	case "fix2":
		return map[string]string{
			...
			"manque":      "La décision d'Epicenter Einstein avant un envoi, un paiement, ou un permis déposé.",
