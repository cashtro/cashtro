...
func Chain(line string) ([]ChainStep, bool) {
	...
	case "control":
		return []ChainStep{
			{Line: "control", Order: 1, Agent: "manager", Do: "Lire le tableau et nommer les trous. Ne pas trancher à la place de Tartaria."},
	...
	case "wordpress":
		return []ChainStep{
			...
			{Line: "wordpress", Order: 2, Agent: "operator", Do: "Le commit va seulement sur un site WordPress (PHP, ACF Pro, XAMPP) ou sur Proximity, Proximity App, l'API, ou Next. Pas Lovable. Pas Tartaria. Pas Voltron. Pas une autre marque."},
	...
	case "nft-giant":
		return []ChainStep{
			{Line: "nft-giant", Order: 1, Agent: "init", Do: "Voltron ouvre. Le cerveau est celui de Giant, Evolu-Jeunes/Giant/brain. Ce n'est pas le cerveau de Tartaria."},
			...
			{Line: "nft-giant", Order: 3, Agent: "manager", Do: "Tartaria décide en dernier. Un mint, un ordre, un déploiement ou un pont reste arrêté."},
		}, true
	case "ecole":
		return []ChainStep{
	...
	case "marketing":
		return []ChainStep{
			...
			{Line: "marketing", Order: 6, Agent: "manager", Do: "Tartaria décide en dernier. Sans lui, la note reste un brouillon."},
		}, true
	case "fix2":
		return []ChainStep{
			...
			{Line: "fix2", Order: 4, Agent: "manager", Do: "Tartaria décide en dernier. Le cycle des quarante agents s'arrête là."},
		}, true
	case "empire":
		return []ChainStep{
