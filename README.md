...
human confirms are first-class. Delivery, research, and **Architect.plan**
are live without a model. Watch keeps the desk flowing while things are
closed. The disk image is `data/cashtro.json`. New agentics register into
this kernel — they do not fork a second product.
