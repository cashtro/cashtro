...
func Lines() []Line {
	return []Line{
		...
		},
		{
			...
			Repos:    []string{"cashtro/Pandora", "Evolu-Jeunes/Pandora", "Evolu-Jeunes/Panda", "Evolu-Jeunes/Teal"},
		},
		{
		...
		{
			ID: "teal", Name: "Teal voice brain", Brain: "Hustler",
			Mandate: "Evolu-Jeunes Teal: Vapi talk, intern desk, human-gated outbound, every bridge. " +
				"Fresh repo github.com/Evolu-Jeunes/Teal. Cashtro OS remains the manager.",
			Controls: "Teal product lives in Evolu-Jeunes/Teal on :8090. Cashtro OS on :8080 coordinates the fleet.",
			Repos:    []string{"Evolu-Jeunes/Teal"},
		},
	}
}
