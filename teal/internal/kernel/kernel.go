// Package kernel is the Teal voice brain for Evolu-Jeunes.
//
// Talk, outbound calls, intern desk, and every business-line bridge.
// Cashtro OS remains the manager; this repo is the Evolu-Jeunes product.
package kernel
...
const (
	...
	Name = "Teal"
	// Version is the Evolu-Jeunes Teal release.
	Version = "0.1.0"
)
...
func (k *Kernel) About() About {
	...
	return About{
		Name:     Name,
		Version:  Version,
		Motto:    "Evolu-Jeunes Teal — voice across every bridge.",
		...
		Resident: resident,
		Events:   len(k.events),
		Manifesto: "Teal is the Evolu-Jeunes voice brain. Vapi talks and dials (human-gated). " +
			"Intern desk, Teams ingest, and every business line share one script. " +
			"Cashtro OS stays the manager at cashtro/cashtro. This repo is the Evolu-Jeunes product.",
	}
}
